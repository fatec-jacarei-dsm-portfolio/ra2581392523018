...
function App() {
  // A lógica de busca e categorização agora está encapsulada no hook.
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-slate-50 pt-24 px-6 pb-20 overflow-x-hidden">
          ...
          <section id="projetos">
            ...
            {!loading && !error && (
              <div className="space-y-24">
                ...
                {/* SUBSEÇÃO: PROJETOS PESSOAIS */}
                {projpessoais.length > 0 && (
                  <div>
